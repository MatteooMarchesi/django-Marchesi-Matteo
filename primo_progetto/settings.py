...
SECRET_KEY = 'django-insecure-#$$v$lpre(+02x^t$$q@x6)s1bmklydm@p_i^=ht)^tjyjyili'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'seconda_app/templates'),os.path.join(BASE_DIR, 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
